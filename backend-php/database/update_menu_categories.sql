-- STEP 1: Update existing menu items to use lowercase categories
UPDATE menu SET kategori = 'makanan' WHERE kategori = 'Makanan';
UPDATE menu SET kategori = 'minuman' WHERE kategori = 'Minuman';
UPDATE menu SET kategori = 'snack' WHERE kategori = 'Snack';
UPDATE menu SET kategori = 'dessert' WHERE kategori = 'Dessert';

-- STEP 2: Add new sample menu data with beautiful images
INSERT INTO menu (nama_menu, kategori, harga, deskripsi, stok, foto_makanan) VALUES
-- Makanan (jika belum ada)
